...
export default component$(() => {
  return (
    <section class="relative mt-16 md:-mt-[86px] not-prose">
  ...
  <span class="block lg:inline">Experienced</span>
  <span class="block md:inline lg:block">Family Lawyer</span>
  <span class="block text-[#039de1] sm:whitespace-nowrap">in Toronto</span>
</h1>
